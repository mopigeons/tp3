...
public class TestTransaction {
    ...
    public static void testTransactionsMain() {
        ...
        t.ajouterCompteABanque(1, 100, 1, new Date(13, 4, 2016));
        ...
        System.out.println("Cas valide:");
        totalCounter++;
        t.fermerCompteABanque(1, 1, new Date(15, 4, 2016));
        System.out.println("ok");
        okCounter++;
        ...
        t1.ajouterNouvelleBanque();
        t1.ajouterCompteABanque(1, 100, 1, new Date(13, 4, 2016));
        t1.ajouterCompteABanque(2, 100, 2, new Date(13, 4, 2016));
        t1.transactionBancaire(1, 1, 2, 2, 10);
        System.out.println("ok");
        okCounter++;
        ...
        totalCounter++;
        try {
            t1.transactionBancaire(1, 1, 3, 2, 10);
        ...
        totalCounter++;
        try {
            t1.transactionBancaire(1, 1, 1, 1, 10);
            throw new IllegalStateException("ERREUR: Cas invalide doit provoquer une exception");
        }
        catch(IllegalArgumentException e) {
            System.out.println("*" + e.getMessage());
        ...
        totalCounter++;
        try {
            t1.transactionBancaire(1, 1, 2, 1, 10);
            throw new IllegalStateException("ERREUR: Cas invalide doit provoquer une exception");
        }
        catch(IllegalArgumentException e) {
            System.out.println("*" + e.getMessage());
        ...
        totalCounter++;
        try {
            t1.ajouterCompteABanque(1, 100, 3, new Date(13, 4, 2016));
            t1.fermerCompteABanque(1, 3, new Date(15, 4, 2016));
            t1.transactionBancaire(1, 3, 2, 2, 10);
            throw new IllegalStateException("ERREUR: Cas invalide doit provoquer une exception");
        }
        catch(IllegalArgumentException e) {
            System.out.println("*" + e.getMessage());
        ...
        totalCounter++;
        try {
            t1.transactionBancaire(1, 1, 2, 2, 200);
            throw new IllegalStateException("ERREUR: Cas invalide doit provoquer une exception");
        }
        catch(IllegalArgumentException e) {
            System.out.println("*" + e.getMessage());
        ...
        totalCounter++;
        try {
            t1.ajouterCompteABanque(2, 1, 3, new Date(13, 4, 2016));
            t1.transactionBancaire(1, 1, 2, 3, 1);
            throw new IllegalStateException("ERREUR: Cas invalide doit provoquer une exception");
        }
        catch(IllegalArgumentException e) {
            System.out.println("*" + e.getMessage());
